...
function loadTable() {
    $('#bsTable').bootstrapTable({
        ...
        columns: [
            ...
            {field: 'paramKey', title: '参数键名'},
            {field: 'paramValue', title: '参数键值'},
            {field: 'paramDesc', title: '参数描述'},
            {field: 'createTime', title: '创建时间', sortable: true, sortName: 'create_time'},
            {field: 'updateTime', title: '最后更新时间', sortable: true, sortName: 'update_time'}
        ]
    });
}
...
$("#btnAdd").click(function () {
    window.parent.fopen(baseUrl + "/add", "新增", 600, 375);
});
...
$("#btnEdit").click(function () {
    ...
    window.parent.fopen(baseUrl + "/edit/" + rows[0].id, "修改", 600, 375);
});
