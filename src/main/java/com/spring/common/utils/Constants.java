...
public class Constants {
     ...
     * 头像默认保存目录
     */
    public static final String HEAD_SAVE_DIR = "/WEB-INF/upload/imgs";
    /**
     * 头像默认保存路径
     */
    public static final String DEFAULT_HEAD_PATH = "/statics/img/profile.jpg";
