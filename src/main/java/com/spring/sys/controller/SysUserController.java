...
public class SysUserController extends BaseController {
    ...
    @PostMapping("/hasUser")
    @ResponseBody
    boolean hasUser(@RequestParam Map<String, Object> params) {
        return !sysUserService.hasUser(params);
    }
    ...
    @PostMapping("/save")
    @ResponseBody
    public Result save(@RequestBody SysUserInfo user) {
    ...
    @PostMapping("/update")
    @ResponseBody
    public Result update(@RequestBody SysUserInfo user) {
